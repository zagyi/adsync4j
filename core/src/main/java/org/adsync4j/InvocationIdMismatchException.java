 ...
 * Invocation ID) does not match the ID stored in the {@link DomainControllerAffiliation#getInvocationId() affiliation record}.
 * This happens when the database on the server side is restored from a backup.<br>
 * Since the highest committed USN stored in the {@link org.adsync4j.DomainControllerAffiliation#getHighestCommittedUSN()
